        ...
        <div ref={contentRef} className="relative">
          ...
          {solutionData && (
            <div className="bg-transparent w-fit">
              <div className="pb-3">
                <div className="space-y-3 w-fit" style={{height: "5vh", overflowY: "auto" }}>
                  <ScreenshotQueue
          ...
          <div className="w-full text-sm text-black bg-black/60 rounded-md">
            <div className="rounded-lg overflow-hidden">
              <div className="px-4 py-3 space-y-4 max-w-full" style={{height: "82vh", overflowY: "auto" }}>
...
{solutionData && (
                  <>
                    <ContentSection
                      title="Problem Statement"
                      content={solutionData.problem_statement}
                      isLoading={false}
                    />
                    <ContentSection
                      title="Approach"
                      content={solutionData.approach}
                      isLoading={false}
                    />
                    <SolutionSection
                      title="Solution"
...
{/* <div className="flex w-full h-full gap-6">
  <div className="flex-1 min-w-0 space-y-4">
    <ContentSection title="Problem Statement" content={solutionData.problem_statement} isLoading={false} />
    <ContentSection title="Approach" content={solutionData.approach} isLoading={false} />
    <ComplexitySection timeComplexity={solutionData.time_complexity} spaceComplexity={solutionData.space_complexity} isLoading={!solutionData.time_complexity || !solutionData.space_complexity} />
  </div>
